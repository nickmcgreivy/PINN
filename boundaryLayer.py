...
# import math  # unused
# from scipy.interpolate import griddata  # unused
# import scipy  # unused
# import scipy.io  # unused
    ...
    def trainSGD(self, numSteps):
        for i in range(numSteps):
            for X in self.generator(self.x, self.N_batch):
                tf_dict = {self.f: X}
                _, l, lf, lz, lo = self.sess.run(
                    [self.optimizer, self.loss, self.lossf, self.loss_zero,
                     self.loss_one], feed_dict=tf_dict)
